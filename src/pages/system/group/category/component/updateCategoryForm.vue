 ...
 * @LastEditTime: 2024-05-26 20:18:33
-->
<template>
  <div>
    <el-form
    ...
    >
      <el-row type="flex" justify="center">
        <el-col :span="16">
          <el-form-item label="分类名称" prop="category_name">
            <el-input v-model="updateCategoryForm.category_name" placeholder="名称" />
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" justify="center">
        <el-col :span="16">
          <el-form-item label="分类代码标识" prop="category_code">
            <el-input v-model="updateCategoryForm.category_code" placeholder="代码标识" />
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" justify="center">
        <el-col :span="16">
          <el-form-item label="排序" prop="sort">
            <el-input v-model="updateCategoryForm.sort" />
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" justify="center">
        <el-col :span="16">
          <el-form-item label="分润比例" prop="rate">
            <el-input v-model="updateCategoryForm.rate" />
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" justify="center">
        <el-col :span="24">
          <el-form-item label="备注信息" prop="remark_info">
            <el-input
              v-model="updateCategoryForm.remark_info"
              type="textarea"
              :rows="1"
      ...
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="分类图片" prop="category_picture_id">
            <UploadSinglePicture
              :picture-id.sync="updateCategoryForm.category_picture_id"
              show-content="分类图片"
              :before-picture-string="updateCategoryForm.picture"
      ...
      <el-row type="flex" justify="center">
        <el-col :span="12" :offset="4">
          <el-form-item>
            <el-button type="primary" @click="submitForm('updateCategoryForm')">修改分类</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="4">
          <el-form-item>
            <el-button @click="resetForm('updateCategoryForm')">重置</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
import { updateCategory } from '@/api/system/group/category'
...
export default
{
  ...
  data()
  {
    return {
      ...
      updateCategoryRules: {
        ...
        rate: [
          { required: true, message: '必须有分润比例', trigger: 'blur' },
  ...
  watch:
  {
    beforeCategoryForm: {
      handler(value)
      {
        this.updateCategoryForm = JSON.parse(JSON.stringify(value))
      },
      deep: true,
      immediate: true
    }
  ...
  methods:
  {
    initCategoryForm()
    {
      ...
      this.updateCategoryForm = Object.assign({}, this.beforeCategoryForm)
    },
    // 提交表单
    submitForm: debounce(function(formName)
    {
      this.$refs[formName].validate((valid) =>
      {
        if (valid)
        {
          this.updateCategory(this.updateCategoryForm)
        }
        else
        {
          console.log('未通过验证!')
