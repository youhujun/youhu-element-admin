 ...
 * @LastEditTime: 2023-08-30 15:30:17
-->
<template>
  <div>
    <el-form
      ref="updateUserLevelForm"
      :model="updateUserLevelForm"
      :rules="updateUserLevelRules"
      label-width="150px"
      :inline="true"
      label-position="left"
      status-icon
    ...
    >
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="排序" prop="sort">
            <el-input v-model="updateUserLevelForm.sort" placeholder="默认100" class="input" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="级别名称" prop="level_name">
            <el-input v-model="updateUserLevelForm.level_name" placeholder="请输入级别名称" class="input" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="级别编码" prop="level_code">
            <el-input v-model="updateUserLevelForm.level_code" placeholder="请输入级别编码" class="input" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="金额" prop="amount">
            <el-input v-model="updateUserLevelForm.amount" placeholder="请输入" class="input" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="描述" prop="bak_info">
            <el-input
              v-model="updateUserLevelForm.bak_info"
              type="textarea"
              placeholder="请填写描述"
              class="input"
              maxlength="32"
      ...
      <el-row type="flex">
        <el-col :span="24" class="center">
          <el-form-item label="背景图片" prop="background_id">
            <UploadSinglePicture
              :picture-id.sync="updateUserLevelForm.background_id"
              show-content="背景图片"
              :before-picture-string="updateUserLevelForm.background.picture"
      ...
      <el-row type="flex">
        <el-col :span="12" class="center">
          <el-form-item>
            <el-button type="primary" @click="submitForm('updateUserLevelForm')">修改用户级别</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="4">
          <el-form-item>
            <el-button @click="resetForm('updateUserLevelForm')">重置</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
<script>
import { updateUserLevel } from '@/api/system/level/userLevel'
...
export default
{
  ...
  watch:
  {
    beforeUserLevelForm: {
      handler(value)
      {
        this.updateUserLevelForm = JSON.parse(JSON.stringify(value))
        if (!value.background)
        {
          this.updateUserLevelForm.background = {}
        }
      },
      deep: true,
      immediate: true
  ...
  methods:
  {
    ...
    {
      this.$refs.updateUserLevelForm.resetFields()
    },
    // 提交表单
    submitForm: debounce(function(formName)
    {
      this.$refs[formName].validate((valid) =>
      {
        if (valid)
        {
          this.updateUserLevel(this.updateUserLevelForm)
        }
        else
        {
          console.log('未通过验证!')
