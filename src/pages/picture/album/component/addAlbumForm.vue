 ...
 * @LastEditTime: 2024-06-02 15:03:54
    ...
    >
      <el-row type="flex" justify="center">
        <el-col :span="14">
          <el-form-item label="相册类型" prop="album_type">
            <el-select v-model="addAlbumForm.album_type" placeholder="请选择" class="select">
              <el-option
      ...
      <el-row type="flex" justify="center">
        <el-col :span="14">
          <el-form-item label="相册名称" prop="album_name">
            <el-input v-model="addAlbumForm.album_name" placeholder="相册名称" class="input" />
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" justify="center">
        <el-col :span="14">
          <el-form-item label="描述" prop="album_description">
            <el-input
              v-model="addAlbumForm.album_description"
              type="textarea"
              :rows="3"
              placeholder="相册描述"
              class="input"
      ...
      <el-row type="flex" justify="center">
        <el-col :span="14">
          <el-form-item label="排序" prop="sort">
            <el-input v-model="addAlbumForm.sort" class="input" />
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" justify="center">
        <el-col :span="12" :offset="4">
          <el-form-item>
            <el-button type="primary" @click="submitForm('addAlbumForm')">添加相册</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="4">
          <el-form-item>
            <el-button @click="resetForm('addAlbumForm')">重置</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
<script>
import { addAlbum } from '@/api/picture/album'
...
export default
{
  ...
  mounted()
  {
    ...
    console.log(this.roles.includes('develop')) */
  ...
  methods:
  {
    ...
    submitForm: debounce(function(formName)
    {
      this.$refs[formName].validate((valid) =>
      {
        if (valid)
        {
          this.addAlbum(this.addAlbumForm)
        }
        else
        {
          console.log('未通过验证!')
    ...
    addAlbum(data)
    {
      ...
      addAlbum(data).then(res =>
      {
        if (res && res.code === 0)
        {
          that.$emit('update:addAlbumData', res.data)
