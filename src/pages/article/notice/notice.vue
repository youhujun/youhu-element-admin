 ...
 * @LastEditTime: 2024-06-11 22:22:11
-->
<template>
  <div>
    <Card>
      ...
      <template #cardNotice>
        <el-tag size="mini" type="danger" effect="plain">公告提示</el-tag>
      </template>
      <template #cardButton>
        <el-button style="float: right; " type="primary" round @click="handleAddNotice()">添加公告</el-button>
      </template>
...
import AddArticleForm from '@/pages/article/notice/component/addArticleForm'
import UpdateArticleForm from '@/pages/article/notice/component/updateArticleForm'

import Search from '@/pages//article/notice/component/search'
import ArticleTable from '@/pages//article/notice/component/articleTable'
...
export default
{
  ...
  methods:
  {
    ...
    closeDialogUpdate(data)
    {
      this.dialogVisibleUpdate = data
    },
    // 获取文章
    async getArticle()
    {
