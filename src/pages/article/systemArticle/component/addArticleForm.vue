 ...
 * @LastEditTime: 2022-09-30 18:13:48
  ...
  methods:
  {
    ...
    submitForm: debounce(function(formName)
    {
      this.$refs[formName].validate((valid) =>
      {
        if (valid)
        {
          // console.log(JSON.stringify(this.addArticleForm.content))
          this.addArticleForm.content = JSON.stringify(this.addArticleForm.content)
