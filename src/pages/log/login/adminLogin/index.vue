 ...
 * @LastEditTime: 2024-06-02 21:39:10
-->
<template>
  <div>
    <Card>
...
import Search from '@/pages/log/login/adminLogin/component/search'
import LoginTable from '@/pages/log/login/adminLogin/component/loginTable'

import { getAdminLoginLog } from '@/api/log/log'
export default
{
  // 组件名称
  name: 'LoginLog',
  ...
  methods:
  {
    ...
    {
      const loginLogData = await getAdminLoginLog(where).then(res =>
      {
