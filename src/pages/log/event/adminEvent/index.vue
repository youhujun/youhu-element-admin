 ...
 * @LastEditTime: 2024-06-21 17:15:15
-->
<template>
  <div>
    <Card>
...
import Search from '@/pages/log/event/adminEvent/component/search'
import EventTable from '@/pages/log/event/adminEvent/component/eventTable'

import { getAdminEventLog } from '@/api/log/log'
...
export default
{
  ...
  methods:
  {
    ...
    {
      const eventLogData = await getAdminEventLog(where).then(res =>
      {
