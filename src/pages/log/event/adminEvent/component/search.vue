 ...
 * @LastEditTime: 2024-06-21 17:29:04
-->
<template>
  <div>
    <el-row type="flex">
      ...
      <el-col :span="7">
        ...
        <el-select v-model="where.sortType" clearable placeholder="请选择排序方式" style="margin-right:0.5rem;">
          <el-option
      ...
      <el-col :span="7">
        <SelectDefaultAdmin :admin-id.sync="where.admin_id" />
      </el-col>
    </el-row>
    <el-row>
...
import SelectDefaultAdmin from '@/pages/component/options/user/selectDefaultAdmin'
export default
{
  // 组件名称
  name: 'Search',
